...
$records = read("SELECT * FROM biodata_siswa");
...
<div class="table-responsive my-4 container sh">
	...
	<?php foreach( $records as $record ) : ?>
		...
		<tbody class="text-center">
			...
			<tr>
				...
				<th><?php echo $record["NAMA_LENGKAP"];  ?></th>

				<th><?php echo $record["KELAS"];  ?></th>

				<th>

					<a href="hapus.php?id=<?= $record["ID"]; ?>" onclick="confirm('Yakin dihapus ?');">HAPUS</a> 

					  |  <a href="detail.php?id=<?= $record["ID"]; ?>">DETAIL</a>
